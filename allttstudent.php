	...
	<main class="d-flex flex-nowrap">
		<div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 280px; height:100vh;">
			...
			<ul class="nav nav-pills flex-column mb-auto">
				...
				<li>
					<a href="/TimeTableGenerator/allttstudent.php" class="nav-link active text-white">
						<svg class="bi pe-none me-2" width="16" height="16">
		...
		<div class="dashboard-content container-fluid">
			<div class="dashboard-heading display-4">All Timetables</div>
			<form>
				<div class="container">
					<div class="mb-3">
						...
						<select class="form-select" name="year" onchange="fetch_updatedata(this.value)">
							...
							while ($row = mysqli_fetch_assoc($data)) {
								echo '<option value="' . $row['year'] . '">' . $row['year'] . ' Year</option>';
							}
							?>
						</select>
					</div>
