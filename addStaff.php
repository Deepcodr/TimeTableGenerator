...
<body>
    ...
    <main class="d-flex flex-nowrap">
        ...
        <div id="content container-fluid my-auto text-center" style="width: 80vw;">
            <div class="display-1">Add New Staff</div>
            ...
            <table id="stafftable" style="margin-left: 80px">
                <caption><strong>Staff Information </strong></caption>
                <tr>
